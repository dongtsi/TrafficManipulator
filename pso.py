...
class PSO:
    ...
    def execute(self,
        ...
        for iter in range(self.max_iter):
            ...
            for i in range(0,self.particle_num,self.grp_size):
                ...
                for j in range(i,i+self.grp_size):
                    ...
                    self.swarm[j].evaluate(mimic_set,nstat,tmp_pcap_file)
            ...
            # print("*"*64)
            print("[Result] Step",iter,"Finished...Global best value:",self.global_best_dis)
        ...
        ics_time = cur_end_time - groupList[-1].time

        return ics_time,cur_end_time,STA_best_X,STA_best_feature,STA_best_pktList,self.STA_glb_dis_list,self.STA_avg_dis_list